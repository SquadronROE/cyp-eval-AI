  ...
  describe("notifications from user interactions", function () {
    it(
      ...
      function () {
        ...
        cy.getBySelLike("like-").click();
        // a successful "like" should disable the button and increment
        // the number of likes
        cy.getBySelLike("like").should("be.disabled");
        ...
        cy.getBySelLike("notification-item")
    ...
    it("User C likes a transaction between User A and User B; User A and User B get notifications that User C liked transaction", function () {
      ...
      cy.getBySelLike("notification-list")
    ...
    it("User A sends a payment to User B", function () {
      ...
      cy.createTransaction({
        //TO DO: finish creating transaction for wait, must have transactionType: String - amount: Integer, description: String, sender: ctx.User, receiver, ctx.secondUser
